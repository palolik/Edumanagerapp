package com.kotlin5.edumanager.presentation.admin.adapter
...
import com.kotlin5.edumanager.databinding.ActivityCourseReviewBinding
...
class CourseList(private val activity: Activity) : RecyclerView.Adapter<CourseList.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val binding =ActivityCourseReviewBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    inner class MyViewHolder(private val binding:ActivityCourseReviewBinding) : RecyclerView.ViewHolder(binding.root) {
